    ...
    setMessages([
      {
        role: 'assistant',
        content:
          "Hi, I’m the BMS Assistant. Tell me what services you’re interested in (e.g., ‘6 acupuncture sessions and one IV per month’) and I’ll explain memberships and bundles that might fit."
      }
    ])
  }, [])
